        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-start">
          ...
          <div className="animate-fadeUp">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-2 text-sm font-medium text-neutral-800 shadow-sm ring-1 ring-black/5">
              ...
              Community-powered stray reporting in Davao City
            </div>
            ...
            <p className="mt-4 text-lg text-neutral-800">
              A hopeful, fast, and secure platform that lets residents report stray animals
              immediately—then connects nearby volunteers and updates the case status through a ticket ID.
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link
                href="/how-it-works"
                className="inline-flex items-center justify-center rounded-xl px-2 py-3 font-semibold text-secondary underline decoration-secondary/50 underline-offset-4 transition hover:decoration-secondary"
              >
                How it Works
              </Link>
            </div>
            ...
            {/* Partner Section */}
            <div className="mt-10 rounded-3xl bg-white/70 p-6 shadow-sm ring-1 ring-black/5">
              <div className="flex items-center justify-between gap-3">
                <h2 className="text-lg font-bold text-primary">Partner volunteer groups</h2>
                <Link
                  href="/partners"
              ...
              <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
                {partnerGroups.map((p) => (
                  <div
                    key={p.name}
                    className="flex items-center gap-3 rounded-2xl bg-white p-3 shadow-sm ring-1 ring-black/5 transition hover:-translate-y-0.5 hover:shadow-md"
                  >
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl bg-white p-7 shadow-sm ring-1 ring-black/5">
          <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
              <h3 className="text-2xl font-extrabold text-primary">Our Community Impact</h3>
